...
//        contact = new Contact("Mary Jane", "333222111", "maryJ@yahoo.com", "Jane's Emporium", sales);
//        contact1 = new Contact("Peter Parker", "999888777", "peterP@yahoo.com", "Webs", sales);
...
//        Contact testContact = new Contact("Rick","079492222","rick@westley.com","Zombies", sales);
//        testContactList.add(testContact);
//
//        List<Opportunity> testOpportunityList = new ArrayList<>();
//        Opportunity testOpportunity = new Opportunity(Product.HYBRID, 3, testContact, sales);
...
//
//    @Test
//    @DisplayName("Test: getOpportunity(). Return null as Opportunity doesn't exist.")
...
//
//        List<Opportunity> testOpportunityList = new ArrayList<>();
//        Opportunity testOpportunity = new Opportunity(Product.HYBRID, 3, testContact, 0);
//        testOpportunityList.add(testOpportunity);
//
//        Account testAccount = new Account(Industry.ECOMMERCE, 2, "Berlin", "Germany", testContactList, testOpportunityList);
